...
public class InterceptMouseEvents extends JPanel {
	...
	MouseMotionListener, MouseWheelListener {
		...
		public void mouseWheelMoved(MouseWheelEvent e) {
			for (final MouseWheelListener l : forwardTo
		...
		public void mouseDragged(MouseEvent e) {
			for (final MouseMotionListener l : forwardTo
		...
		public void mouseClicked(MouseEvent e) {
			for (final MouseListener l : forwardTo.getListeners(MouseListener.class)) {
				l.mouseClicked(e);
			}
		}
	...
	private final MapView forwardTo;

	private final MouseEventForwarder forwarder = new MouseEventForwarder();
